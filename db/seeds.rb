...
categoryEducation.addOption("High school")
categoryEducation.addOption("Post-secondary/college")
categoryEducation.addOption("Vocational")
categoryEducation.addOption("GED program")
