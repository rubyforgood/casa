  ...
  def update
    ...
    if @case_contact.update_cleaning_contact_types(update_case_contact_params)
      ...
      if @case_contact.valid?
        redirect_to casa_case_path(@case_contact.casa_case), notice: I18n.t("case_contact.update", case_contact_id: @case_contact.id, created_at: @case_contact.created_at)
      else
        render :edit
      end
    else
