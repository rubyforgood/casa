class CasaOrg < ApplicationRecord
  ...
  has_many :supervisor_volunteers, :through => :users, :source => :volunteers #this is number2
  has_many :case_assignments, :through => :users, :source => :casa_cases #this is number3
  #has_many :case_contacts, :through => :users, :source => :volunteers         #this is number1
