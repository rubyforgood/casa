module SmsBodyHelper
  def account_activation_msg(resource = "primorgens", base_url = "hello kitty", hash_of_links = {})
    first_msg = "A CASA #{resource} account was created for you."
    second_msg = " First, set your password here #{hash_of_links[0]}."
    third_msg = " Then visit #{hash_of_links[1]}" + "/users/edit" + " to change your text message settings."
