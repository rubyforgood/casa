...
# This is an autogenerated file for dynamic methods in `CaseCourtOrdersController`.
# Please instead update this file by running `bin/tapioca dsl CaseCourtOrdersController`.

class CaseCourtOrdersController
