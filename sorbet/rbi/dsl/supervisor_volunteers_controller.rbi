...
# This is an autogenerated file for dynamic methods in `SupervisorVolunteersController`.
# Please instead update this file by running `bin/tapioca dsl SupervisorVolunteersController`.

class SupervisorVolunteersController
