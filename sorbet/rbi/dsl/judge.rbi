...
# This is an autogenerated file for dynamic methods in `Judge`.
# Please instead update this file by running `bin/tapioca dsl Judge`.
...
class Judge
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Judge).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Judge).void)).returns(::Judge) }
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Judge)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Judge) }
    def find_by!(*args); end
    ...
    sig { params(arg: T.untyped, args: T.untyped).returns(::Judge) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Judge, T::Enumerable[T.any(::Judge, T::Enumerable[::Judge])])
    ...
    sig do
      params(
        records: T.any(::Judge, Integer, String, T::Enumerable[T.any(::Judge, Integer, String, T::Enumerable[::Judge])])
      ).returns(T::Array[::Judge])
    end
    ...
    sig do
      params(
        other_array: T.any(::Judge, T::Enumerable[T.any(::Judge, T::Enumerable[::Judge])])
      ).returns(T::Array[::Judge])
    end
