...
# This is an autogenerated file for dynamic methods in `CaseCourtReportsController`.
# Please instead update this file by running `bin/tapioca dsl CaseCourtReportsController`.

class CaseCourtReportsController
