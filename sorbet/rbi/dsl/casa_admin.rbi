...
# This is an autogenerated file for dynamic methods in `CasaAdmin`.
# Please instead update this file by running `bin/tapioca dsl CasaAdmin`.
...
class CasaAdmin
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::CasaAdmin).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::CasaAdmin).void)
      ).returns(::CasaAdmin)
    end
    ...
    sig { returns(T::Array[::CasaAdmin]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::CasaAdmin)) }
    def fifth; end

    sig { returns(::CasaAdmin) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::CasaAdmin)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::CasaAdmin) }
    def find_by!(*args); end
    ...
    sig { params(arg: T.untyped, args: T.untyped).returns(::CasaAdmin) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::CasaAdmin } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::CasaAdmin, T::Enumerable[T.any(::CasaAdmin, T::Enumerable[::CasaAdmin])])
    ...
    sig do
      params(
        records: T.any(::CasaAdmin, Integer, String, T::Enumerable[T.any(::CasaAdmin, Integer, String, T::Enumerable[::CasaAdmin])])
      ).returns(T::Array[::CasaAdmin])
    end
    ...
    sig do
      params(
        other_array: T.any(::CasaAdmin, T::Enumerable[T.any(::CasaAdmin, T::Enumerable[::CasaAdmin])])
      ).returns(T::Array[::CasaAdmin])
    end
