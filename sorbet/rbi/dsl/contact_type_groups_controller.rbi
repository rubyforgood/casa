...
# This is an autogenerated file for dynamic methods in `ContactTypeGroupsController`.
# Please instead update this file by running `bin/tapioca dsl ContactTypeGroupsController`.

class ContactTypeGroupsController
