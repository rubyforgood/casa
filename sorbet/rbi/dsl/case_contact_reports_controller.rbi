...
# This is an autogenerated file for dynamic methods in `CaseContactReportsController`.
# Please instead update this file by running `bin/tapioca dsl CaseContactReportsController`.

class CaseContactReportsController
