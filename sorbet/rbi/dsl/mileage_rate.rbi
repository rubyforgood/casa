...
# This is an autogenerated file for dynamic methods in `MileageRate`.
# Please instead update this file by running `bin/tapioca dsl MileageRate`.
...
class MileageRate
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::MileageRate).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::MileageRate).void)
      ).returns(::MileageRate)
    end
    ...
    sig { returns(T::Array[::MileageRate]) }
    def destroy_all; end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::MileageRate)) }
    def fifth; end

    sig { returns(::MileageRate) }
    def fifth!; end

    sig { params(args: T.untyped).returns(T.untyped) }
    def find(*args); end

    sig { params(args: T.untyped).returns(T.nilable(::MileageRate)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::MileageRate) }
    def find_by!(*args); end
    ...
    sig { params(arg: T.untyped, args: T.untyped).returns(::MileageRate) }
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::Date)) }
    def effective_date_before_last_save; end

    sig { returns(T.untyped) }
    def effective_date_before_type_cast; end

    sig { returns(T::Boolean) }
    def effective_date_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::Date), T.nilable(::Date)])) }
    def effective_date_change; end

    sig { returns(T.nilable([T.nilable(::Date), T.nilable(::Date)])) }
    def effective_date_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def effective_date_changed?; end

    sig { returns(T.nilable(::Date)) }
    def effective_date_in_database; end

    sig { returns(T.nilable([T.nilable(::Date), T.nilable(::Date)])) }
    def effective_date_previous_change; end

    sig { returns(T::Boolean) }
    def effective_date_previously_changed?; end

    sig { returns(T.nilable(::Date)) }
    def effective_date_previously_was; end

    sig { returns(T.nilable(::Date)) }
    def effective_date_was; end

    sig { void }
    def effective_date_will_change!; end
    ...
    sig { void }
    def restore_effective_date!; end
    ...
    sig { returns(T.nilable([T.nilable(::Date), T.nilable(::Date)])) }
    def saved_change_to_effective_date; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_effective_date?; end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::MileageRate } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::MileageRate, T::Enumerable[T.any(::MileageRate, T::Enumerable[::MileageRate])])
    ...
    sig do
      params(
        records: T.any(::MileageRate, Integer, String, T::Enumerable[T.any(::MileageRate, Integer, String, T::Enumerable[::MileageRate])])
      ).returns(T::Array[::MileageRate])
    end
    ...
    sig do
      params(
        other_array: T.any(::MileageRate, T::Enumerable[T.any(::MileageRate, T::Enumerable[::MileageRate])])
      ).returns(T::Array[::MileageRate])
    end
