...
# This is an autogenerated file for dynamic methods in `AllCasaAdmins::PatchNotesController`.
# Please instead update this file by running `bin/tapioca dsl AllCasaAdmins::PatchNotesController`.

class AllCasaAdmins::PatchNotesController
