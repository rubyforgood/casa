...
# This is an autogenerated file for dynamic methods in `AllCasaAdmins::DashboardController`.
# Please instead update this file by running `bin/tapioca dsl AllCasaAdmins::DashboardController`.

class AllCasaAdmins::DashboardController
