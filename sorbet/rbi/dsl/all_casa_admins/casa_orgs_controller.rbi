...
# This is an autogenerated file for dynamic methods in `AllCasaAdmins::CasaOrgsController`.
# Please instead update this file by running `bin/tapioca dsl AllCasaAdmins::CasaOrgsController`.

class AllCasaAdmins::CasaOrgsController
