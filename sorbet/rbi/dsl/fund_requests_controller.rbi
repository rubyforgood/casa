...
# This is an autogenerated file for dynamic methods in `FundRequestsController`.
# Please instead update this file by running `bin/tapioca dsl FundRequestsController`.

class FundRequestsController
