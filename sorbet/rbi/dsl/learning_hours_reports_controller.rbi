...
# This is an autogenerated file for dynamic methods in `LearningHoursReportsController`.
# Please instead update this file by running `bin/tapioca dsl LearningHoursReportsController`.

class LearningHoursReportsController
