...
# This is an autogenerated file for dynamic methods in `CasaOrgController`.
# Please instead update this file by running `bin/tapioca dsl CasaOrgController`.

class CasaOrgController
