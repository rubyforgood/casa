...
# This is an autogenerated file for dynamic methods in `VolunteersController`.
# Please instead update this file by running `bin/tapioca dsl VolunteersController`.
