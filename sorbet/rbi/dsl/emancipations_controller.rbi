...
# This is an autogenerated file for dynamic methods in `EmancipationsController`.
# Please instead update this file by running `bin/tapioca dsl EmancipationsController`.
