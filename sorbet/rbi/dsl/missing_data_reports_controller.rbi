...
# This is an autogenerated file for dynamic methods in `MissingDataReportsController`.
# Please instead update this file by running `bin/tapioca dsl MissingDataReportsController`.

class MissingDataReportsController
