...
# This is an autogenerated file for dynamic methods in `CaseContacts::FollowupsController`.
# Please instead update this file by running `bin/tapioca dsl CaseContacts::FollowupsController`.

class CaseContacts::FollowupsController
