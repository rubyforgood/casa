...
# This is an autogenerated file for dynamic methods in `CasaCasesController`.
# Please instead update this file by running `bin/tapioca dsl CasaCasesController`.

class CasaCasesController
