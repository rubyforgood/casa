...
# This is an autogenerated file for dynamic methods in `CaseAssignmentsController`.
# Please instead update this file by running `bin/tapioca dsl CaseAssignmentsController`.

class CaseAssignmentsController
