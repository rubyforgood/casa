...
# This is an autogenerated file for dynamic methods in `ContactTypesController`.
# Please instead update this file by running `bin/tapioca dsl ContactTypesController`.
