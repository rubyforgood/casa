...
# This is an autogenerated file for dynamic methods in `AllCasaAdminsController`.
# Please instead update this file by running `bin/tapioca dsl AllCasaAdminsController`.

class AllCasaAdminsController
