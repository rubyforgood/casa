...
# This is an autogenerated file for dynamic methods in `CourtDatesController`.
# Please instead update this file by running `bin/tapioca dsl CourtDatesController`.

class CourtDatesController
