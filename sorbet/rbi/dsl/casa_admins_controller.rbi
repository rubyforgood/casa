...
# This is an autogenerated file for dynamic methods in `CasaAdminsController`.
# Please instead update this file by running `bin/tapioca dsl CasaAdminsController`.

class CasaAdminsController
