...
# This is an autogenerated file for dynamic methods in `CaseContactsController`.
# Please instead update this file by running `bin/tapioca dsl CaseContactsController`.

class CaseContactsController
