...
class Faraday::Request < ::Struct
  # source://faraday/1.10.2/lib/faraday/request.rb#112
  def [](key); end

  # source://faraday/1.10.2/lib/faraday/request.rb#118
  def []=(key, value); end

  # source://faraday/1.10.2/lib/faraday/request.rb#60
  def _deprecated_method; end

  # source://faraday/1.10.2/lib/faraday/request.rb#81
  def headers=(hash); end

  # source://faraday/1.10.2/lib/faraday/request.rb#125
  def marshal_dump; end

  # source://faraday/1.10.2/lib/faraday/request.rb#139
  def marshal_load(serialised); end

  # source://faraday/1.10.2/lib/faraday/deprecate.rb#86
  def method(*args, &block); end

  # source://faraday/1.10.2/lib/faraday/request.rb#70
  def params=(hash); end

  # source://faraday/1.10.2/lib/faraday/request.rb#149
  def to_env(connection); end

  # source://faraday/1.10.2/lib/faraday/request.rb#94
  def url(path, params = T.unsafe(nil)); end

  class << self
    # source://faraday/1.10.2/lib/faraday/request.rb#54
    def create(request_method); end
  end
end

# source://faraday/1.10.2/lib/faraday.rb#32
...
# source://faraday/1.10.2/lib/faraday.rb#33
...
class Faraday::Response
  # source://faraday/1.10.2/lib/faraday/response.rb#28
  def initialize(env = T.unsafe(nil)); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def [](*args, **_arg1, &block); end

  # source://faraday/1.10.2/lib/faraday/response.rb#96
  def apply_request(request_env); end

  # source://faraday/1.10.2/lib/faraday/response.rb#49
  def body; end

  # source://faraday/1.10.2/lib/faraday/response.rb#33
  def env; end

  # source://faraday/1.10.2/lib/faraday/response.rb#66
  def finish(env); end

  # source://faraday/1.10.2/lib/faraday/response.rb#53
  def finished?; end

  # source://faraday/1.10.2/lib/faraday/response.rb#43
  def headers; end

  # source://faraday/1.10.2/lib/faraday/response.rb#86
  def marshal_dump; end

  # source://faraday/1.10.2/lib/faraday/response.rb#90
  def marshal_load(env); end

  # source://faraday/1.10.2/lib/faraday/response.rb#57
  def on_complete(&block); end

  # source://faraday/1.10.2/lib/faraday/response.rb#39
  def reason_phrase; end

  # source://faraday/1.10.2/lib/faraday/response.rb#35
  def status; end

  # source://faraday/1.10.2/lib/faraday/response.rb#74
  def success?; end

  # source://faraday/1.10.2/lib/faraday/response.rb#78
  def to_hash; end
end
