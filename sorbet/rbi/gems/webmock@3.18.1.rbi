...
module HTTP
  class << self
    # source://http/5.1.0/lib/http/chainable.rb#182
    def [](headers); end
  end
end
...
class HTTP::Client
  # source://http/5.1.0/lib/http/client.rb#21
  def initialize(default_options = T.unsafe(nil)); end

  # source://http/5.1.0/lib/http/client.rb#64
  def __perform__(req, options); end

  # source://http/5.1.0/lib/http/client.rb#40
  def build_request(verb, uri, opts = T.unsafe(nil)); end

  # source://http/5.1.0/lib/http/client.rb#97
  def close; end
  ...
  # source://http/5.1.0/lib/http/client.rb#28
  ...
  # source://http/5.1.0/lib/http/client.rb#111
  def build_response(req, options); end

  # source://http/5.1.0/lib/http/client.rb#192
  def make_form_data(form); end

  # source://http/5.1.0/lib/http/client.rb#177
  def make_request_body(opts, headers); end

  # source://http/5.1.0/lib/http/client.rb#160
  def make_request_headers(opts); end

  # source://http/5.1.0/lib/http/client.rb#142
  def make_request_uri(uri, opts); end

  # source://http/5.1.0/lib/http/client.rb#124
  def verify_connection!(uri); end

  # source://http/5.1.0/lib/http/client.rb#105
  def wrap_request(req, opts); end
end

# source://http/5.1.0/lib/http/client.rb#19
HTTP::Client::HTTP_OR_HTTPS_RE = T.let(T.unsafe(nil), Regexp)

# source://webmock//lib/webmock/http_lib_adapters/http_rb/request.rb#2
class HTTP::Request
  # source://http/5.1.0/lib/http/request.rb#86
  def initialize(opts); end

  # source://http/5.1.0/lib/http/request.rb#77
  def body; end

  # source://http/5.1.0/lib/http/request.rb#164
  def connect_using_proxy(socket); end

  # source://http/5.1.0/lib/http/request.rb#169
  def headline; end

  # source://forwardable/1.3.2/forwardable.rb#229
  def host(*args, **_arg1, &block); end

  # source://http/5.1.0/lib/http/request.rb#154
  def include_proxy_authorization_header; end

  # source://http/5.1.0/lib/http/request.rb#148
  def include_proxy_headers; end

  # source://http/5.1.0/lib/http/request.rb#215
  def inspect; end

  # source://http/5.1.0/lib/http/request.rb#77
  def proxy; end

  # source://http/5.1.0/lib/http/request.rb#158
  def proxy_authorization_header; end

  # source://http/5.1.0/lib/http/request.rb#181
  def proxy_connect_header; end

  # source://http/5.1.0/lib/http/request.rb#186
  def proxy_connect_headers; end

  # source://http/5.1.0/lib/http/request.rb#103
  def redirect(uri, verb = T.unsafe(nil)); end

  # source://http/5.1.0/lib/http/request.rb#70
  def scheme; end

  # source://http/5.1.0/lib/http/request.rb#198
  def socket_host; end

  # source://http/5.1.0/lib/http/request.rb#203
  def socket_port; end

  # source://http/5.1.0/lib/http/request.rb#133
  def stream(socket); end

  # source://http/5.1.0/lib/http/request.rb#76
  def uri; end

  # source://http/5.1.0/lib/http/request.rb#72
  def uri_normalizer; end

  # source://http/5.1.0/lib/http/request.rb#144
  def using_authenticated_proxy?; end

  # source://http/5.1.0/lib/http/request.rb#139
  def using_proxy?; end

  # source://http/5.1.0/lib/http/request.rb#67
  def verb; end
  ...
  # source://http/5.1.0/lib/http/request.rb#232
  def default_host_header_value; end

  # source://http/5.1.0/lib/http/request.rb#227
  def port; end

  # source://http/5.1.0/lib/http/request.rb#236
  def prepare_body(body); end

  # source://http/5.1.0/lib/http/request.rb#240
  def prepare_headers(headers); end
end

# source://http/5.1.0/lib/http/request.rb#29
HTTP::Request::METHODS = T.let(T.unsafe(nil), Array)

# source://http/5.1.0/lib/http/request.rb#59
HTTP::Request::PORTS = T.let(T.unsafe(nil), Hash)

# source://http/5.1.0/lib/http/request.rb#56
HTTP::Request::SCHEMES = T.let(T.unsafe(nil), Array)

# source://http/5.1.0/lib/http/request.rb#27
HTTP::Request::USER_AGENT = T.let(T.unsafe(nil), String)

# source://webmock//lib/webmock/http_lib_adapters/http_rb/response.rb#2
class HTTP::Response
  # source://http/5.1.0/lib/http/response.rb#45
  def initialize(opts); end

  # source://http/5.1.0/lib/http/response.rb#26
  def body; end

  # source://forwardable/1.3.2/forwardable.rb#229
  def charset(*args, **_arg1, &block); end

  # source://http/5.1.0/lib/http/response.rb#146
  def chunked?; end
  ...
  # source://http/5.1.0/lib/http/response.rb#107
  def content_length; end

  # source://http/5.1.0/lib/http/response.rb#126
  def content_type; end

  # source://http/5.1.0/lib/http/response.rb#140
  def cookies; end

  # source://http/5.1.0/lib/http/response.rb#97
  def flush; end

  # source://http/5.1.0/lib/http/response.rb#165
  def inspect; end

  # source://forwardable/1.3.2/forwardable.rb#229
  def mime_type(*args, **_arg1, &block); end

  # source://http/5.1.0/lib/http/response.rb#160
  def parse(type = T.unsafe(nil)); end

  # source://http/5.1.0/lib/http/response.rb#32
  ...
  # source://http/5.1.0/lib/http/response.rb#29
  def request; end

  # source://http/5.1.0/lib/http/response.rb#20
  def status; end

  # source://http/5.1.0/lib/http/response.rb#90
  def to_a; end
  ...
  # source://http/5.1.0/lib/http/response.rb#23
  def version; end

  private

  # source://http/5.1.0/lib/http/response.rb#171
  def default_encoding; end

  # source://http/5.1.0/lib/http/response.rb#180
...
# source://http/5.1.0/lib/http/version.rb#4
