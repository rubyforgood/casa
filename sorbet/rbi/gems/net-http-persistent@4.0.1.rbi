...
class Net::HTTP::Persistent
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#471
  def initialize(name: T.unsafe(nil), proxy: T.unsafe(nil), pool_size: T.unsafe(nil)); end

  # An SSL certificate authority.  Setting this will set verify_mode to
  # VERIFY_PEER.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#247
  def ca_file; end

  # Sets the SSL certificate authority file.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#536
  def ca_file=(file); end

  # A directory of SSL certificates to be used as certificate authorities.
  # Setting this will set verify_mode to VERIFY_PEER.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#253
  def ca_path; end

  # Sets the SSL certificate authority path.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#545
  ...
  # For Net::HTTP parity
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#236
  def cert; end

  # Sets this client's OpenSSL::X509::Certificate
  # For Net::HTTP parity
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#524
  def cert=(certificate); end

  # An SSL certificate store.  Setting this will override the default
  # certificate store.  See verify_mode for more information.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#259
  def cert_store; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#264
  def ciphers; end

  # The ciphers allowed for SSL connections
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#564
  def ciphers=(ciphers); end

  # Creates a new connection for +uri+
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#573
  ...
  # hole.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#272
  ...
  # CGI::escape wrapper
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#624
  def escape(str); end
  ...
  # @return [Boolean]
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#640
  def expired?(connection); end

  # Finishes the Net::HTTP +connection+
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#669
  def finish(connection); end

  # Current connection generation
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#277
  def generation; end

  # Headers that are added to every request using Net::HTTP#add_field
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#282
  def headers; end
  ...
  # specific features.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#288
  def http_versions; end

  # Maximum time an unused connection can remain idle before being
  # automatically closed.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#294
  ...
  # require this header.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#318
  def keep_alive; end
  ...
  # For Net::HTTP parity
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#728
  def key=(key); end

  # Maximum number of requests on a connection before it is considered expired
  # and automatically closed.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#300
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#422
  def max_version; end

  # maximum SSL version to use
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1048
  ...
  # and server.  Ruby 2.5 and newer only.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#414
  def min_version; end

  # Minimum SSL version to use
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1039
  def min_version=(min_version); end

  # The name for this collection of persistent connections.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#323
  def name; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#328
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#719
  def pipeline(uri, requests, &block); end

  # Test-only accessor for the connection pool
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#358
  def pool; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#751
  def proxy=(proxy); end
  ...
  # @return [Boolean]
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#825
  ...
  # variables.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#798
  ...
  # connections.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#841
  def reconnect; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#880
  ...
  # Returns the request.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#919
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#950
  def shutdown; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#388
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#393
  def ssl_generation; end

  # SSL session lifetime
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#398
  def ssl_timeout; end

  # SSL session lifetime
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1021
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#406
  def ssl_version; end

  # SSL version to use
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1030
  def ssl_version=(ssl_version); end

  # Starts the Net::HTTP +connection+
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#651
  def start(http); end

  # Where this instance's last-use times live in the thread local variables
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#427
  def timeout_key; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#432
  def verify_callback; end

  # SSL verification callback.
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1079
  ...
  # Sets the depth of SSL certificate verification
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1057
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#448
  def verify_mode; end
  ...
  #
  # source://net-http-persistent//lib/net/http/persistent.rb#1070
  ...
  class << self
    ...
    #
    # source://net-http-persistent//lib/net/http/persistent.rb#197
...
class Net::HTTP::Persistent::Connection
  ...
  # source://net-http-persistent//lib/net/http/persistent/connection.rb#29
  def reset; end

  # source://net-http-persistent//lib/net/http/persistent/connection.rb#34
...
# source://net-http-persistent//lib/net/http/persistent.rb#167
...
class Net::HTTP::Persistent::Pool < ::ConnectionPool
  ...
  # source://net-http-persistent//lib/net/http/persistent/pool.rb#31
  def checkout(net_http_args); end

  # source://net-http-persistent//lib/net/http/persistent/pool.rb#4
  def key; end

  # source://net-http-persistent//lib/net/http/persistent/pool.rb#46
  def shutdown; end
end
...
#
# source://net-http-persistent//lib/net/http/persistent.rb#175
