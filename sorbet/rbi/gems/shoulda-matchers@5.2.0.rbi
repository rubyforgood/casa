...
class Shoulda::Matchers::ActiveModel::ValidateAbsenceOfMatcher < ::Shoulda::Matchers::ActiveModel::ValidationMatcher
  ...
  # @return [Boolean]
  #
  # source://shoulda-matchers//lib/shoulda/matchers/active_model/validate_absence_of_matcher.rb#145
  def array_column?; end

  # @return [Boolean]
  #
  # source://shoulda-matchers//lib/shoulda/matchers/active_model/validate_absence_of_matcher.rb#132
  def collection?; end

  # source://shoulda-matchers//lib/shoulda/matchers/active_model/validate_absence_of_matcher.rb#126
  def column_type; end
  ...
  # source://shoulda-matchers//lib/shoulda/matchers/active_model/validate_absence_of_matcher.rb#156
  def enum_values; end

  # source://shoulda-matchers//lib/shoulda/matchers/active_model/validate_absence_of_matcher.rb#140
  def reflection; end
