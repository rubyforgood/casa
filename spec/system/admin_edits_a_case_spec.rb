...
RSpec.describe "admin edits case", type: :system do
  ...
  let(:back_button_casa_case) { create(:casa_case, casa_org: organization) }
  let(:edit_casa_case) { create(:casa_case, casa_org: organization) }
  ...
  it "clicks back button after editing case" do
    sign_in admin
    visit edit_casa_case_path(back_button_casa_case)
  ...
  it "edits case" do
    sign_in admin
    visit casa_case_path(edit_casa_case.id)
