...
namespace :after_party do
  ...
  task migrate_court_report_due_date_to_court_dates: :environment do
    ...
    casa_cases.each do |casa_case|
      casa_case_last_court_date = casa_case.court_dates.last
      casa_case_last_court_date.court_report_due_date = casa_case.court_report_due_date
      casa_case_last_court_date.save
    end

    # casa_cases.each do |casa_case|
    #   casa_case.court_dates.each do |court_date|
    #     court_date.court_report_due_date = casa_case.court_report_due_date
    #     court_date.save
    #   end
    # end
